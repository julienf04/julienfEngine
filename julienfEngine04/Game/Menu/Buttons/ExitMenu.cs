...
namespace julienfEngine1
{
    class ExitMenu : GameObject, IClickable
    {
        ...
        public ExitMenu(Figure[] figures, Scene myScene, byte baseFigure = 0, bool visible = true, bool isUI = false, byte layer = 0,
        ...
        public void OnClick()
        {
            julienfEngine.SetLoadedScene(typeof(ExitMenuScene), true);
        }
