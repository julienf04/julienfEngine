...
{
    class MultiplayerOffline : GameObject, IClickable
    {
           ...
           (new string[8]
               {
                    ...
                    @"|  \/  |     | | | (_)     | |                              / _|/ _| (_)           ",
                    @"| .  . |_   _| | |_ _ _ __ | | __ _ _   _  ___ _ __    ___ | |_| |_| |_ _ __   ___ ",
        ...
        public MultiplayerOffline(int posX, int posY, bool visible) : base(posX, posY, visible)
        {
            this.P_GameObjectFigures = new Figure[1] { _figureMultiplayerOffline };
        }

        public MultiplayerOffline(int posX, int posY, bool visible, bool isUI, byte layer) : base(posX, posY, visible, isUI, layer)
        {
            this.P_GameObjectFigures = new Figure[1] { _figureMultiplayerOffline };
        }

        public MultiplayerOffline(int posX, int posY, bool visible, bool isUI, byte layer, Figure[] figures, byte baseFigure)
        ...
        void IClickable.OnClick()
        {
            ...
            Scene.LoadScene(typeof(GameScene), new object[] { GameScene.E_GameType.MultiplayerOffline });
